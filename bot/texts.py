...
TEXTS: dict[str, dict[str, str]] = {
    "ru": {
        ...
        "about_text": (
            ...
            "<b>📤 Автопостинг</b> (в карточке агента)\n"
            "Постинг от вашего <b>Telegram-аккаунта</b> (не бота) через MTProto. Привяжите "
            "аккаунт (api_id/api_hash с my.telegram.org → телефон → код → 2FA), добавьте "
            "источники и каналы-цели и выберите режим:\n"
            "▫️ <b>↪️ Пересылка</b> — копировать новые сообщения источников в цели.\n"
            "▫️ <b>✍️ Структурирование</b> — переписывать каждое новое сообщение ИИ.\n"
            "▫️ <b>🧵 Тема-дайджест</b> — собрать до 300 сообщений (с датой/ником/id), выделить "
            "тему и сделать один пост (или не постить, если темы нет).\n"
            "Анти-бан настраивается: интервал, случайный разброс, лимит за окно. Промпт "
            "автопостинга — отдельный, со своей библиотекой.\n\n"

            "<b>Команды:</b> /start — запуск, /menu — главный экран, /help — справка, "
        ...
        "agent_autopost_btn": "📤 Автопостинг",
        "agent_web_title": (
            "🌐 <b>Веб-поиск</b>\n\n"
            "Состояние: <b>{state}</b>\n"
